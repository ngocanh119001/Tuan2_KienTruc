...
public class FrmMain extends JFrame {
	...
	public static void main(String[] args) {
		...
		try {
			//thiáº¿t láº­p mĂ´i trÆ°á»�ng cho JMS
			BasicConfigurator.configure();
			//thiáº¿t láº­p mĂ´i trÆ°á»�ng cho JJNDI
			...
			=(Destination) ctx.lookup("dynamicQueues/tranthanhthanh");
			//táº¡o connection
			...
			//receiver.receive();
			//Cho receiver láº¯ng nghe trĂªn queue, chá»«ng cĂ³ message thĂ¬ notify - async
			System.out.println("TĂ½ was listened on queue...");
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					producer.send(msg);
					Person p=new Person(1001, "Tha", new Date());
